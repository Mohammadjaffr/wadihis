...
<head>
    ...
    <title>
        @yield('title', 'tailadmin')
    </title>
    <link rel="icon" href="{{ asset('tailadmin/build/favicon.ico') }}" type="image/x-icon">
...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
    ...
    <div class="relative z-1 flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
        ...
        <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
            ...
            <img src="{{ asset('tailadmin/src/images/error/404.svg') }}" alt="404" class="dark:hidden" />
            <img src="{{ asset('tailadmin/src/images/error/404-dark.svg') }}" alt="404"
