...
@section('content')
    <div x-data="{ isProfileInfoModal: false, isProfileAddressModal: false }" class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        ...
        @include('pages.partials.profile.profile-info-modal')
        @include('pages.partials.profile.profile-address-modal')
    </div>
@endsection
