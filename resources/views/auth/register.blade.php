                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input id="name" name="name" type="text" value="{{ old('name') }}" required
                                        ...
                                        class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" id="password" name="password"
                                            ...
                                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                ...
                                <div class="flex items-start text-sm text-gray-500 dark:text-gray-400">
                                    <input id="terms" type="checkbox" required
                                        class="mt-1 mr-2 rounded text-brand-500">
                                    By creating an account, you agree to our
                                    <a href="#" class="ml-1 text-brand-500 hover:text-brand-600">Terms</a> and
                                    <a href="#" class="ml-1 text-brand-500 hover:text-brand-600">Privacy Policy</a>.
                                </div>
                ...
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="{{ route('login') }}" class="block mb-4">
                            <img src="{{ asset('tailadmin/src/images/logo/auth-logo.svg') }}" alt="Logo" />
                        </a>
