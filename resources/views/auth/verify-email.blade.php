                ...
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                    <div class="mb-5 sm:mb-8 text-center">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Thanks for signing up! Please check your email inbox for a verification link.
                            <br>
                    ...
                    <div class="mt-5 text-center">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="text-sm font-medium text-gray-600 underline hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200">
                                Log Out
                            </button>
                        </form>
                    </div>
