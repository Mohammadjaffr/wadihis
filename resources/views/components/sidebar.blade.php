<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="index.html">
            ...
            <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'" src="{{ asset('tailadmin/src/images/logo/logo-icon.svg') }}"
                alt="Logo" />
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('form_elements') }}" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('basic_tables') }}" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('blank') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('page404') }}" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('lineChart') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('barChart') }}" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('alerts') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('avatars') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('badge') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('buttons') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('images') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('videos') }}" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('signin') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('signup') }}" class="menu-dropdown-item group"
